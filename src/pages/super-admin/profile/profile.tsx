...
return (
  <div className="p-3 sm:p-6 md:p-8 max-w-3xl mx-auto space-y-6 sm:space-y-8 animate-in fade-in duration-500">
    {/* HEADER SECTION */}
    <div className="flex flex-col sm:flex-row sm:items-center justify-between border-b pb-5 sm:pb-6 gap-4">
      <div>
    ...
    <Card className="border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] bg-white overflow-hidden rounded-2xl pt-0">
      {/* CARD HEADER */}
      <CardHeader className="bg-linear-to-r from-slate-50 to-white border-b border-slate-100 py-6 sm:py-8 px-4 sm:px-6">
        <div className="flex items-center gap-4 sm:gap-6">
          <div className="relative group shrink-0">
            ...
            <div className="relative p-1 bg-white rounded-full border border-slate-100">
              <div className="p-3 sm:p-4 bg-slate-50 rounded-full">
                <User
                  className="w-8 h-8 sm:w-10 sm:h-10 text-[#ff8f00]"
                  strokeWidth={1.5}
                />
              </div>
            </div>
          ...
          <div className="space-y-1 min-w-0">
            <CardTitle className="text-xl sm:text-2xl font-bold text-slate-800 tracking-tight truncate">
              {admin?.username}
            </CardTitle>
            <div className="flex flex-wrap items-center gap-2">
              ...
              <span className="h-1 w-1 bg-slate-300 rounded-full hidden sm:block"></span>
      ...
      <CardContent className="p-4 sm:p-6 md:p-8 space-y-6 sm:space-y-8">
        ...
        {/* Tizimli ma'lumotlar */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 pt-4 border-t border-slate-50">
          <div className="flex items-center gap-4 p-4 rounded-2xl bg-slate-50/30 border border-slate-100/50">
            <div className="p-2 bg-white shadow-sm rounded-lg shrink-0">
              <Calendar className="w-4 h-4 text-blue-500" />
            </div>
